...
import com.dowellcomputer.naviexam.Announce.Notice;
import com.dowellcomputer.naviexam.Announce.NoticeListAdapter;
import com.dowellcomputer.naviexam.ETC.LoginActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new NoticeActivity.BackgroundTask().execute();
